...
let scan_declarations parameters  = 
  List.fold_left 
    (fun remanent (a,_) -> scan_agent parameters remanent a) 
...
let scan_rules parameters a b =  
  ...
  in 
    List.fold_left 
      (fun remanent (_,rule) -> scan_mixture parameters (scan_mixture parameters remanent rule.Ckappa_sig.lhs) rule.Ckappa_sig.rhs)
      a b
...
let scan_compil parameters error compil =
   ...
   let remanent = scan_initial_states parameters remanent compil.Ckappa_sig.init in 
   let remanent = scan_declarations parameters remanent compil.Ckappa_sig.signatures  in 
   let remanent = scan_observables parameters remanent compil.Ckappa_sig.observables in 
   let remanent = scan_perts parameters remanent compil.Ckappa_sig.perturbations in 
   let remanent = scan_rules parameters remanent compil.Ckappa_sig.rules in 
     remanent 
