  ...
  * Last modification: 2011, the 30rd of March
  * * 
...
let print_diffview parameters error handler diff =
 ...
 let print_var parameters error handler var = 
   match var with 
     | Cckappa_sig.VAR_KAPPA (x,_) -> print_mixture parameters error handler x 
     | Cckappa_sig.VAR_ALG (x,y) -> print_short_alg parameters error handler x 
