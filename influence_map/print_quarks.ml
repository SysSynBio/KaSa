  ...
  * Last modification: March the 9th 2011
  * * 
...
let print_agents parameter error handler quark = 
  ...
  let error = print_agent_map parameter_var error handler quark.Quark_type.agent_var in 
...
let print_sites parameter error handler quark = 
  ...
  let error = print_site_map parameter_var error handler quark.Quark_type.site_var in 
  ...
  let _  = 
    Quark_type.Int2Set_and_map.fold_map
      (fun (a,b) couple error -> 
         ...
         let error,()_ = Handler.print_rule_or_var parameters error handler compilation print_rule print_var a in 
         let _ = Printf.fprintf parameters.Remanent_parameters_sig.log "->" in 
         let error,()  = Handler.print_rule_or_var parameters error handler compilation print_rule print_var b in 
        ...
        then 
          ...
          let rec aux k error = 
             if k>= nrules then error 
               ...
               let error,_ = Handler.print_rule_or_var parameters_dot error handler compilation Handler.print_rule_dot Handler.print_var_dot k in 
